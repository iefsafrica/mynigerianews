...
class SubscriptionController extends AppBaseController
{
         ...
         public function purchaseSubscription(Request $request)
         {
                  ...
                  return $this->sendResponse($result, __('messages.placeholder.session_created_successfully'));
         }
         ...
         public function userSubscribedPlanUpdate(UpdateSubscriptionPlanRequest $request): JsonResponse
         {

...
<div class="row gx-10 mb-5">
    ...
    <div class="col-md-6 mb-5">
        ...
        <label class="form-check form-check-custom form-check-sm form-check-solid {{ auth()->user()->language == 'ar' ? 'float-start' : 'float-end' }}">
            ...
            @foreach($permissions as $permission)
                <div class="col-lg-6 mb-5">
                    ...
                    <label class="form-check form-check-sm form-check-custom form-check-solid {{ auth()->user()->language == 'ar' ? 'float-start' : 'float-end' }}">

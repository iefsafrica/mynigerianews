...
<div class="pt-7">
<ul class="nav nav-tabs mb-5 pb-1 overflow-auto text-nowrap" id="subAnalytics" role="tablist">
    ...
    <li class="nav-item position-relative me-7 mb-3" role="presentation">
        <a class="nav-link p-0 {{ (isset($sectionName) && $sectionName == 'theme_configuration') ? 'active' : ''}}"
           href="{{ route('setting.index',['section' => 'theme_configuration']) }}">{{__('messages.setting.theme_configuration')}}</a>
    </li>
</ul>
</div>

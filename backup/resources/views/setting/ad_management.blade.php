                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 my-3">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active {{ auth()->user()->language == 'ar' ? 'float-none' : '' }}" name="header" id="showCaptcha"
                    ...
                    <div class="col-lg-8 my-3">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active {{ auth()->user()->language == 'ar' ? 'float-none' : '' }}" name="index_top" id="showCaptcha"
                    ...
                    <div class="col-lg-8 my-3">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active {{ auth()->user()->language == 'ar' ? 'float-none' : '' }}" name="index_bottom" id="showCaptcha"
                    ...
                    <div class="col-lg-8 my-3">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active {{ auth()->user()->language == 'ar' ? 'float-none' : '' }}" name="post_details" id="showCaptcha"
                    ...
                    <div class="col-lg-8 my-3">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active {{ auth()->user()->language == 'ar' ? 'float-none' : '' }}" name="details_side" id="showCaptcha"
                    ...
                    <div class="col-lg-8 my-3">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active {{ auth()->user()->language == 'ar' ? 'float-none' : '' }}" name="categories" id="showCaptcha"
                    ...
                    <div class="col-lg-8 my-3">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active {{ auth()->user()->language == 'ar' ? 'float-none' : '' }}" name="trending_post" id="showCaptcha"
                    ...
                    <div class="col-lg-8 my-3">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active {{ auth()->user()->language == 'ar' ? 'float-none' : '' }}" name="popular_news" id="showCaptcha"
                    ...
                    <div class="col-lg-8 my-3">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active {{ auth()->user()->language == 'ar' ? 'float-none' : '' }}" name="trending_post_index_page" id="showCaptcha"
                    ...
                    <div class="col-lg-8 my-3">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active {{ auth()->user()->language == 'ar' ? 'float-none' : '' }}" name="popular_news_index_page" id="showCaptcha"
                    ...
                    <div class="col-lg-8 my-3">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active {{ auth()->user()->language == 'ar' ? 'float-none' : '' }}" name="recommended_post_index_page" id="showCaptcha"

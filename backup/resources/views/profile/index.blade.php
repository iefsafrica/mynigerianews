                    ...
                    <div class="collapse show">
                        <div class="card-body p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <div>
                                        {{ Form::tel('contact', $user->contact,['class' => 'form-control'.( auth()->user()->language == 'ar' ? ' text-end' : ' text-start'),'placeholder' => __('messages.user.contact_number'),'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")','id'=>'phoneNumber']) }}
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                </div>
                            </div>

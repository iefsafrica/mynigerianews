...
{{--    </button>--}}
    ...
    {{-- <div id="ContentQuillData"></div>
    {{ Form::hidden('content', $page->content??null, ['id' => 'edit_content_details']) }} --}}
    <div id="addContentQuillData"></div>
    {{ Form::hidden('content', $page->content??null, ['id' => 'content_details']) }}

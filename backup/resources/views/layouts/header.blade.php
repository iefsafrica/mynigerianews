    ...
    <ul class="nav align-items-center">
        ...
        <li class="px-sm-3 px-2">
            <div class="dropdown d-flex align-items-center py-4">
                ...
                <button class="btn dropdown-toggle {{ auth()->user()->language == 'ar' ? 'pe-2 ps-0' : 'ps-2 pe-0' }} " type="button" id="dropdownMenuButton1"
                ...
                <div class="dropdown-menu py-7 pb-4 my-2" aria-labelledby="dropdownMenuButton1">
                    ...
                    <ul class="pt-4 pe-0">
                        <li>
                            <a class="dropdown-item text-gray-900 cursor-pointer {{ auth()->user()->language == 'ar' ? 'text-end' : '' }}" href="{{ route('profile.setting') }}">
                            <span class="dropdown-icon {{ auth()->user()->language == 'ar' ? 'ms-4' : 'me-4' }} text-gray-600 {{ auth()->user()->language == 'ar' ? 'float-end' : '' }}">
                        ...
                        @if(Auth::user()->hasRole('customer'))
                            <li>
                                <a class="dropdown-item text-gray-900 cursor-pointer {{ auth()->user()->language == 'ar' ? 'text-end' : '' }}"
                        ...
                        @endif
                        <li>
                            <a class="dropdown-item text-gray-900 cursor-pointer {{ auth()->user()->language == 'ar' ? 'text-end' : '' }}" id="changePassword">
                                <span class="dropdown-icon {{ auth()->user()->language == 'ar' ? 'ms-4' : 'me-4' }} text-gray-600 {{ auth()->user()->language == 'ar' ? 'float-end' : '' }}">
                        ...
                        <li>
                            <div class="dropdown dropdown-hover">
                                <a class="dropdown-item text-gray-900 {{ auth()->user()->language == 'ar' ? 'text-end' : '' }}" href="#" id="changeLanguage">
                                   <span class="dropdown-icon {{ auth()->user()->language == 'ar' ? 'ms-4' : 'me-4' }} text-gray-600 {{ auth()->user()->language == 'ar' ? 'float-end' : '' }}">
                        ...
                        <li>
                            <a class="dropdown-item text-gray-900 d-flex cursor-pointer {{ auth()->user()->language == 'ar' ? 'text-end' : '' }}">
                                <span class="dropdown-icon {{ auth()->user()->language == 'ar' ? 'ms-4' : 'me-4' }} text-gray-600 {{ auth()->user()->language == 'ar' ? 'float-end' : '' }}">

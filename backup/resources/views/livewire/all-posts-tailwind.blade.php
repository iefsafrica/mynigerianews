                                ...
                                <div class="sm:pt-5 flex flex-wrap">
                                    ...
                                    <div class="flex flex-wrap sm:pt-0 pt-3 sm:pt-1">
                                        <div class="flex items-center mr-5">
                                            ...
                                            <span
                                                class="text-gray-200 sm:text-base text-sm font-medium sm:pt-1">{{ ucfirst(__('messages.common.' . strtolower($post->created_at->format('F')))) }}{{ $post->created_at->format(' d, Y') }}</span>
                                        </div>

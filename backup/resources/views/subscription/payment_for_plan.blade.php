                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6 col-12 d-flex justify-content-center align-items-center mt-5 plan-controls">
                                <div class="mt-5 {{ auth()->user()->language == 'ar' ? ' ms-3 float-end' : ' me-3' }} w-50 {{ $newPlan['amountToPay'] <= 0 ? 'd-none' : '' }}">
                                    {{ Form::select('payment_type', $paymentTypes ,null , ['class' => 'form-select','required', 'id' => 'paymentType', 'data-control' => 'select2', 'placeholder'=>__("messages.subscription.select_payment")]) }}
                                </div>

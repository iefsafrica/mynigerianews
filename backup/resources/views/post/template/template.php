...
<!--                            </button>-->
                            ...
                            <div class="col-md-9 add-post-text-editor mt-md-0 mt-4">
                                <div id="addGalleryContentData-{{:i}}" class="add-gallery-content"></div>
                                <textarea name="gallery_content[]" id="galleryContent-{{:i}}" class="d-none" rows="5"></textarea>
                            </div>
...
<!--                            </button>-->
                            ...
                            <div class="col-md-9 add-post-text-editor mt-md-0 mt-4">
                                <div id="addSortListContentData-{{:i}}" class="add-sort-list-content"></div>
                                <textarea name="sort_list_content[]" id="sortListContent-{{:i}}" class="d-none" rows="5"></textarea>
                            </div>

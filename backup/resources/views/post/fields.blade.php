        ...
        <div class="card-body">
            <div>
                    ...
                    @else
                        <div class="mb-5">
                            ...
                            <div class="d-flex">
                                {{ Form::text('title', isset($post) ? $post->title : old('title'), ['class' => 'form-control', 'placeholder' => __('messages.common.title'), 'required', 'id' => 'postTitle']) }}
                                <button type="button"
                                    class="btn btn-primary  {{ auth()->user()->language == 'ar' ? 'mx-3' : 'ms-3' }}  w-25"
                                    id="OpenAiCall"
                ...
                @if ($sectionType == \App\Models\Post::ARTICLE_TYPE_ACTIVE)
                    ...
                    <div class="my-6">
                        <div id="addArticleContentQuillData"></div>
                        {{ Form::hidden('article_content', null, ['id' => 'articleContentData']) }}
                        <br>
                    </div>
                @elseif($sectionType == \App\Models\Post::VIDEO_TYPE_ACTIVE)
                    ...
                    <div class="my-6">
                        <div id="addVideoContentQuillData"></div>
                        {{ Form::hidden('video_content', null, ['id' => 'videoContentData']) }}
                        <br>
                    </div>
                @elseif($sectionType == \App\Models\Post::AUDIO_TYPE_ACTIVE)
                    ...
                    <div class="my-6">
                        <div id="addAudioContentQuillData"></div>
                        {{ Form::hidden('audio_content', null, ['id' => 'audioContentData']) }}
                        <br>
                    </div>
                @elseif($sectionType == \App\Models\Post::OPEN_AI_ACTIVE)
                    ...
                    <div class="my-6">
                        <div id="addAiContentQuillData"></div>
                        {{ Form::hidden('article_content', null, ['id' => 'aiContentData']) }}
                        <br>
                    </div>
                @endif
                ...
                <div class="form-group">
                    <div class="mb-5 col-lg-12">
                        ...
                        <span data-bs-toggle="tooltip" data-bs-placement="right"
                            title="{{ __('messages.post.additional_image_dimensions_must_be_310X290') }}">
                                            ...
                                            <div class="d-inline-block mt-3 me-2 image-div-{{ $image->id }} ">
                                                <div class="additional-image-picker">
                                                    ...
                                                    <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                                        ...
                                                        <label>
                                                            <button type="button"
                                                                class="btn btn-sm-danger delete-additional-img-btn"
                                                                data-image="{{ $image->id }}"><i
                            ...
                            @foreach ($post->media as $media)
                                @if ($media->collection_name == 'post file')
                                    <div class="d-flex align-items-center file-div-{{ $media->id }}">
                                        ...
                                        <button type="button"
                                            class="btn btn-sm btn-sm-danger ml-5 delete-post-file-btn"
                                            data-file="{{ $media->id }}">
                            ...
                            <div class="accordion-body border-top">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 add-post-text-editor mt-md-0 mt-4">
                                        ...
                                        {{-- <div id="quill-editor-container-1" class="quill-editor">
                                            {!! $post->content ?? null !!}
                                        </div>
                                        <input type="hidden" name="gallery_content[]" id="quill-editor-1-content"> --}}

                                        <div class="col-md-9 add-post-text-editor mt-md-0 mt-4">
                                            <div id="addGalleryContentData-1" class="add-gallery-content"></div>

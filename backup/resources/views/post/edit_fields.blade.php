    ...
    <div class="card">
        <div class="card-body">
            <div>
                <div class="p-0">
                    ...
                    @else
                        <div class="mb-5">
                            ...
                            <div class="d-flex">
                                {{ Form::text('title', isset($post) ? $post->title : old('title'), ['class' => 'form-control', 'placeholder' => __('messages.common.title'), 'required', 'id' => 'postTitle']) }}
                                <button type="button" class="btn btn-primary  {{ auth()->user()->language == 'ar' ? 'mx-3' : 'ms-3' }}  w-25" id="OpenAiCall"
                ...
                {{-- </textarea> --}}
                    <div class="my-6">
                        <div id="editArticleContentQuillData"></div>
                        {{ Form::hidden('article_content', $post->postArticle?->article_content, ['id' => 'editArticleContentData']) }}
                        <br>
                    </div>
                ...
                <div class="my-6">
                    <div id="editVideoContentQuillData"></div>
                    {{ Form::hidden('video_content', $post->postVideo?->video_content, ['id' => 'editVideoContentData']) }}
                    <br>
                </div>
                ...
                <div class="my-6">
                    <div id="editAudioContentQuillData"></div>
                    {{ Form::hidden('audio_content', $post->postAudios?->audio_content, ['id' => 'editAudioContentData']) }}
                    <br>
                </div>
                @elseif($sectionType == \App\Models\Post::OPEN_AI_ACTIVE)
                    ...
                    <div class="my-6">
                        <div id="editAiContentQuillData"></div>
                        {{ Form::hidden('article_content', $post->postArticle?->article_content, ['id' => 'editAiContentData']) }}
                        <br>
                    </div>
                @endif
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex flex-wrap">
                {{ Form::submit(__('messages.post.submit'), ['class' => 'btn btn-primary ' . (auth()->user()->language == 'ar' ? 'ms-2' : 'me-2') . ' mb-2 post-save-btn','id' => 'postSaveBtn']) }}
                            ...
                            <div class="accordion-body border-top">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 add-post-text-editor mt-md-0 mt-4">
                                        ...
                                        <div class="col-md-9 add-post-text-editor mt-md-0 mt-4">
                                            <div id="addGalleryContentData-{{ $loop->index+1 }}" class="add-gallery-content"></div>
                                            <textarea name="gallery_content[]" id="galleryContent-{{ $loop->index+1 }}" class="d-none">{!! $postGallery->gallery_content ?? null !!}</textarea>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 add-post-text-editor mt-md-0 mt-4">
                                        ...
                                        <div class="col-md-9 add-post-text-editor mt-md-0 mt-4">
                                            ...
                                            <textarea name="gallery_content[]" id="galleryContent-1" class="d-none"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-body border-top">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 add-post-text-editor mt-md-0 mt-4">
                                        ...
                                        <div class="col-md-9 add-post-text-editor mt-md-0 mt-4">
                                            <div id="addSortListContentData-{{ $loop->index+1 }}" class="add-sort-list-content"></div>
                                            <textarea name="sort_list_content[]" id="sortListContent-{{ $loop->index+1 }}" class="d-none">{!! $sortedList->sort_list_content ?? null !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-body border-top">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 add-post-text-editor mt-md-0 mt-4">
                                        ...
                                        <div class="col-md-9 add-post-text-editor mt-md-0 mt-4">
                                            <div id="addSortListContentData-1" class="add-sort-list-content"></div>
                                            <textarea name="sort_list_content[]" id="sortListContent-1" class="d-none"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>

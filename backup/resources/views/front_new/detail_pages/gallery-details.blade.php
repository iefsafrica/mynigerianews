                                                ...
                                                <div class="card d-flex flex-row mb-40">
                                                    ...
                                                    <div class="col-8 card-body ms-4 ">
                                                        ...
                                                        <span class="fs-14 text-gray">
                                                               {{ ucfirst(__('messages.common.' . strtolower($previousPost->created_at->format('M')))) }}{{ $previousPost['created_at']->format(' d, Y') }}</span>
                                                    </div>
                                            ...
                                            @if (!empty($nextPost))
                                                <div class="card d-flex flex-row mb-40">
                                                    ...
                                                    <div class="col-8 ms-4 ">
                                                        ...
                                                        <span
                                                            class=" fs-14 text-gray">{{ ucfirst(__('messages.common.' . strtolower($nextPost->created_at->format('M')))) }}{{ $nextPost['created_at']->format(' d, Y') }}</span>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6 mb-2">
                                                    <div class="card position-relative slide-item">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <span
                                                                class="card-text fs-12 text-gray">{{ ucfirst(__('messages.common.' . strtolower($relatedPost->created_at->format('M')))) }}{{ $relatedPost['created_at']->format(' d, Y') }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                @if ($loop->iteration >= 6)
                                    ...
                                    @if (!Auth::check())
                                        <div class="col-md-6">
                                            <input type="text" class="form-control fs-14 text-gray" name="name"
                                                id="name" placeholder="{{ __('messages.comment.enter_your_name') }}" required>
                                        </div>
                                        <div class="col-md-6">
                                            <input type="email" name="email" id="email"
                                                class="form-control fs-14 text-gray" placeholder="{{ __('messages.comment.enter_your_email') }}"
                                                required>
                                        </div>
                                    @endif
                                    <div class="col-12">
                                        <textarea class="form-control fs-14 text-gray" name="comment" id="comment" rows="3"
                                            style="color:rgb(123, 123, 123) !important" placeholder="Type Your Comments" required></textarea>
                                    </div>

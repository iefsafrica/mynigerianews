                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-8 col-7">
                                        <div class="card-body">
                                            ...
                                            <span
                                                class="card-text fs-12 text-gray">{{ ucfirst(__('messages.common.' . strtolower(\Carbon\Carbon::parse($news['created_at'])->format('M')))) }}{{ \Carbon\Carbon::parse($news['created_at'])->format(' d, Y') }}</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 col-7">
                                <div class="card-body">
                                    ...
                                    <span
                                        class="card-text fs-12 text-gray">{{ ucfirst(__('messages.common.' . strtolower($recommendedPost->created_at->format('F')))) }}{{ $recommendedPost['created_at']->format(' d, Y') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>

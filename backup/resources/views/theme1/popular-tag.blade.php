        ...
        <ol class="list-none p-0 inline-flex flex-wrap">
            ...
            <li class="flex items-center">
                <a href="javascript:void(0)"
                    class="text-gray-300 text-sm font-medium">{{ __('messages.details.popular_tags') }}</a>
                <span class="lg:mx-3 mx-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3"
                        stroke="#606060" class="w-3.5 h-3.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
            ...
            <li>
                <a href="javascript:void(0)" class="text-gray-300 text-sm text-primary font-medium">{!! ucfirst(trans($tagName)) !!}</a>
            </li>
        </ol>
    </nav>
</div>

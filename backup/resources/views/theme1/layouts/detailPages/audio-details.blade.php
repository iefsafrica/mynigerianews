...
@section('content')
    ...
    <div class="">
        ...
        <div class="audio-player fixed bottom-0 w-full flex items-center justify-between p-4 border bg-gray-100 md:gap-6 gap-4 z-10 hidden">
            <div class="sm:flex hidden items-center gap-3">
                <img alt="player_img"
                    class="relative rounded-full w-16 h-16 min-w-[64px] object-cover player-img"
                ...
                <div class="flex-grow overflow-hidden">
                    ...
                    <span
                        class="block text-xs text-neutral-500 dark:text-neutral-400">{{ $postDetail->slug }}</span>
                </div>
            </div>
            ...
            <div class="lg:grid lg:grid-cols-3 pt-10 gap-8">
                <div class="col-span-2 sm:mb-0">
                    ...
                    <div class="sm:flex justify-between items-center relative">
                        ...
                        <div class="flex gap-6 px-2 sm:pt-0 pt-4">
                                ...
                                <div :class="{ 'showpopup': open, 'hidden': !open }"
                                    ...
                                    <div class="flex pt-3 gap-3 popup-scrollbar overflow-auto">
                                        ...
                                        <a href="javascript:void(0);" class="flex flex-col items-center px-1.5">
                                            <div class="text-4xl relative emoji-id" data-emoji="{{$emoji->id}}" data-post="{{$postDetail->id}}"> {{ html_entity_decode($emoji->emoji) }}
                                                <span
                                                    class="bg-black rounded-full text-white text-[10px] absolute -top-1 -right-1 w-4 h-4 flex justify-center items-center post-reaction-count  like-reaction" id="{{$emoji->id}}">{{isset($countEmoji[$emoji->id]) ? count($countEmoji[$emoji->id]) : 0}}</span>
                                            </div>
                                            <span class="text-[10px] font-medium">{{ __('messages.reaction.'.$emoji->name) }}</span>
                                        </a>
                                        @endforeach
                                    </div>
                            ...
                            <div class="relative flex flex-col items-center group">
                                ...
                                <div class="absolute bottom-0 flex flex-col items-center hidden mb-6 group-hover:flex">
                                    <span class="relative z-10 p-2 text-xs leading-none text-white whitespace-no-wrap bg-black shadow-lg">{{ __('messages.comment.comment') }}</span>
                                    <div class="w-3 h-3 -mt-2 rotate-45 bg-black"></div>
                                </div>
                            </div>
                            <div @click.away="open = false" x-data="{ open: false }">
                                ...
                                <div :class="{ 'showpopup': open, 'hidden': !open }"
                                    ...
                                    <div class="flex gap-3 popup-scrollbar overflow-auto pb-1">
                                        ...
                                        <a href="https://www.facebook.com/sharer.php?u={{ getUrl() }}" class="bg-blue-600 p-1.5 rounded-lg">
                                        ...
                                        <a  href="https://www.twitter.com/share?url={{ getUrl() }}" class="bg-sky-400 p-1.5 rounded-lg">
                                            <svg class="svg-inline--fa fa-twitter w-5 h-5 text-white" aria-hidden="true"
                                        ...
                                        <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ getUrl() }}" class="bg-sky-600 p-1.5 rounded-lg">
                                            <svg class="svg-inline--fa fa-linkedin w-5 h-5 text-white" aria-hidden="true"
                                        ...
                                        <a  href="https://reddit.com/submit?url={{ getUrl() }}" class="bg-green-600 p-1.5 rounded-lg">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="svg-inline--fa w-5 h-5 text-white" viewBox="0 0 448 512"><path fill="currentColor" d="M64 32l320 0c35.3 0 64 28.7 64 64l0 320c0 35.3-28.7 64-64 64L64 480c-35.3 0-64-28.7-64-64L0 96C0 60.7 28.7 32 64 32zM305.9 166.4c20.6 0 37.3-16.7 37.3-37.3s-16.7-37.3-37.3-37.3c-18 0-33.1 12.8-36.6 29.8c-30.2 3.2-53.8 28.8-53.8 59.9l0 .2c-32.8 1.4-62.8 10.7-86.6 25.5c-8.8-6.8-19.9-10.9-32-10.9c-28.9 0-52.3 23.4-52.3 52.3c0 21 12.3 39 30.1 47.4c1.7 60.7 67.9 109.6 149.3 109.6s147.6-48.9 149.3-109.7c17.7-8.4 29.9-26.4 29.9-47.3c0-28.9-23.4-52.3-52.3-52.3c-12 0-23 4-31.9 10.8c-24-14.9-54.3-24.2-87.5-25.4l0-.1c0-22.2 16.5-40.7 37.9-43.7l0 0c3.9 16.5 18.7 28.7 36.3 28.7zM155 248.1c14.6 0 25.8 15.4 25 34.4s-11.8 25.9-26.5 25.9s-27.5-7.7-26.6-26.7s13.5-33.5 28.1-33.5zm166.4 33.5c.9 19-12 26.7-26.6 26.7s-25.6-6.9-26.5-25.9c-.9-19 10.3-34.4 25-34.4s27.3 14.6 28.1 33.5zm-42.1 49.6c-9 21.5-30.3 36.7-55.1 36.7s-46.1-15.1-55.1-36.7c-1.1-2.6 .7-5.4 3.4-5.7c16.1-1.6 33.5-2.5 51.7-2.5s35.6 .9 51.7 2.5c2.7 .3 4.5 3.1 3.4 5.7z"/></svg>
                                        </a>
                                        @endif
                                        @if (getSettingValue()['whatsapp'])
                                        <a  href="https://wa.me/?text={{ getUrl() }}" class="bg-green-600 p-1.5 rounded-lg">
                                            <svg class="svg-inline--fa fa-whatsapp w-5 h-5 text-white" aria-hidden="true"
                                        ...
                                        @if (!Auth::check())
                                            <div class="sm:grid sm:grid-cols-2 gap-6">
                                                <div class="sm:mb-5 mb-4">
                                                    <input type="text" id="name" name="name" id="commentInputField"
                    ...
                    <div class="mt-5 comment-tailwind">
                        <h5 class="font-semibold xl:text-[22px] comment-data sm:text-xl text-lg text-black mb-4 @if (empty($totalComments)) hidden @endif">

            ...
            <div class="d-flex justify-content-between align-self-center">
                <div class="d-inline-block col-6">
                    <label class="form-check form-check-custom">
                        <input name="auto_update" class="form-check-input {{ auth()->user()->language == 'ar' ? ' ms-3 float-end' : ' me-3' }}" type="radio" value="{{\App\Models\RssFeed::YES}}"
                ...
                <div class="d-inline-block col-6">
                    <label class="form-check form-check-custom">
                        <input name="auto_update" class="form-check-input {{ auth()->user()->language == 'ar' ? ' ms-3 float-end' : ' me-3' }}" type="radio" value="{{\App\Models\RssFeed::NO}}"  {{ isset($rssFeed) ? ($rssFeed->auto_update  == \App\Models\RssFeed::NO ? 'checked' : '') : null}}>
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            <div class="d-flex justify-content-between align-self-center">
                <div class="d-inline-block col-6">
                    <label class="form-check form-check-custom">
                        <input name="show_btn" class="form-check-input {{ auth()->user()->language == 'ar' ? ' ms-3 float-end' : ' me-3' }}" type="radio" value="{{\App\Models\RssFeed::YES}}"
                ...
                <div class="d-inline-block col-6">
                    <label class="form-check form-check-custom">
                        <input name="show_btn" class="form-check-input {{ auth()->user()->language == 'ar' ? ' ms-3 float-end' : ' me-3' }}" type="radio" value="{{\App\Models\RssFeed::NO}}"
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            <div class="d-flex justify-content-between align-self-center">
                <div class="d-inline-block col-6">
                    <label class="form-check form-check-custom">
                        <input name="post_draft" class="form-check-input {{ auth()->user()->language == 'ar' ? ' ms-3 float-end' : ' me-3' }}" type="radio" value="{{\App\Models\RssFeed::YES}}"
                ...
                <div class="d-inline-block col-6">
                    <label class="form-check form-check-custom">
                        <input name="post_draft" class="form-check-input {{ auth()->user()->language == 'ar' ? ' ms-3 float-end' : ' me-3' }}" type="radio" value="{{\App\Models\RssFeed::NO}}"

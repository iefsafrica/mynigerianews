...
Route::prefix('admin')->middleware('auth', 'xss', 'verified.user')->group(function () {
    ...
    Route::middleware('permission:manage_settings')->group(function () {
        ...
        Route::post('/ai-settings', [SettingController::class, 'openAiKeyupdate'])->name('ai-setting.update');
    });
    ...
    Route::middleware('permission:manage_staff')->group(function () {
        ...
        Route::get('resend-email/{staff}', [StaffController::class, 'resendEmail'])->name('resend-email');
    });
    ...
    Route::middleware('permission:manage_all_post')->group(function () {
        ...
        Route::delete('additional-post/{id}', [PostController::class, 'additionalMediadelete'])->name('additional-media.delete');
        ...
        Route::get('post-change-status', [PostController::class, 'updateVisibility'])->name('post.changStatus');
        Route::get('post-change-headline', [PostController::class, 'updateHeadline'])->name('post.changHeadline');
        Route::get('post-change-update-featured', [PostController::class, 'updateFeatured'])->name('post.changUpdateFeatured');
        Route::get('post-change-update-breaking', [PostController::class, 'updateBreaking'])->name('post.changUpdateBreaking');
        Route::get('post-change-update-slider', [PostController::class, 'updateSlider'])->name('post.changUpdateSlider');
        Route::get('post-change-update-recommended', [PostController::class, 'updateRecommended'])->name('post.changUpdateRecommended');
    });
